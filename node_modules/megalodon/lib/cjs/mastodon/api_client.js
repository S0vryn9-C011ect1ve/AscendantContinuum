...
(function (MastodonAPI) {
    var Client = (function () {
        function Client(baseUrl, accessToken, userAgent, axiosInstance) {
        ...
        Client.prototype.post = function (path_1) {
            return __awaiter(this, arguments, void 0, function (path, params, headers) {
                ...
                return __generator(this, function (_a) {
                    ...
                    return [2, this.axios.post(this.baseUrl + path, params, options).then(function (resp) {
                            var res = {
                                data: resp.data,
                                status: resp.status,
                                statusText: resp.statusText,
        ...
        Client.prototype.postForm = function (path_1) {
            return __awaiter(this, arguments, void 0, function (path, params, headers) {
                ...
                return __generator(this, function (_a) {
                    ...
                    return [2, this.axios.postForm(this.baseUrl + path, params, options).then(function (resp) {
                            var res = {
                                data: resp.data,
                                status: resp.status,
                                statusText: resp.statusText,
    ...
    (function (Converter) {
        Converter.encodeNotificationType = function (t) {
            switch (t) {
                ...
                case notification_js_1.default.Update:
                    return notification_js_2.default.Update;
                case notification_js_1.default.AdminSignup:
                    return notification_js_2.default.AdminSignup;
                case notification_js_1.default.AdminReport:
                    return notification_js_2.default.AdminReport;
                default:
        ...
        Converter.decodeNotificationType = function (t) {
            switch (t) {
                ...
                case notification_js_2.default.Update:
                    return notification_js_1.default.Update;
                case notification_js_2.default.AdminSignup:
                    return notification_js_1.default.AdminSignup;
                case notification_js_2.default.AdminReport:
                    return notification_js_1.default.AdminReport;
                default:
                    return new notification_js_1.UnknownNotificationTypeError();
            }
        };
        ...
        Converter.notification = function (n) {
            ...
            if (notificationType instanceof notification_js_1.UnknownNotificationTypeError)
        ...
        Converter.status = function (s) {
            ...
            return ({
                ...
                quote: s.quote ? Converter.quote(s.quote) : null,
                quote_approval: (_a = s.quote_approval) !== null && _a !== void 0 ? _a : { automatic: [], manual: [], current_user: 'unknown' }
            });
        };
        ...
        Converter.quote = function (q) {
            if ('quoted_status' in q) {
                return {
                    state: q.state,
                    quoted_status: q.quoted_status ? Converter.status(q.quoted_status) : null
                };
            }
            else {
                return {

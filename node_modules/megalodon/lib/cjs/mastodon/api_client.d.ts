...
declare namespace MastodonAPI {
    ...
    class Client implements Interface {
        ...
        private axios;
        constructor(baseUrl: string, accessToken?: string | null, userAgent?: string, axiosInstance?: AxiosInstance);
    ...
    namespace Entity {
        ...
        type StatusVisibility = MastodonEntity.StatusVisibility;
        ...
        type ShallowQuote = MastodonEntity.ShallowQuote;
        type QuotedStatus = MastodonEntity.QuotedStatus;
        type Quote = MastodonEntity.Quote;
        type QuoteApproval = MastodonEntity.QuoteApproval;
    }
    namespace Converter {
        ...
        const visibility: (v: MastodonAPI.Entity.StatusVisibility) => MegalodonEntity.StatusVisibility;
        const encodeVisibility: (v: MegalodonEntity.StatusVisibility) => MastodonAPI.Entity.StatusVisibility;
        ...
        const quote: (q: Entity.QuotedStatus) => MegalodonEntity.QuotedStatus;
    }
}

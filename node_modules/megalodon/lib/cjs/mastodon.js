...
var parse_link_header_js_1 = require("./parse_link_header.js");
var api_client_js_1 = __importDefault(require("./mastodon/api_client.js"));
var megalodon_js_1 = require("./megalodon.js");
var default_js_1 = require("./default.js");
var MastodonOAuth = __importStar(require("./mastodon/oauth.js"));
var notification_js_1 = require("./notification.js");
var Mastodon = (function () {
    function Mastodon(baseUrl, accessToken, userAgent, axiosInstance) {
        ...
        this.client = new api_client_js_1.default.Client(baseUrl, token, agent, axiosInstance);
    ...
    Mastodon.prototype.registerApp = function (client_name, options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                scopes = options.scopes || default_js_1.DEFAULT_SCOPE;
    ...
    Mastodon.prototype.createApp = function (client_name, options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                scopes = options.scopes || default_js_1.DEFAULT_SCOPE;
                redirect_uris = options.redirect_uris || default_js_1.NO_REDIRECT;
                params = {
    ...
    Mastodon.prototype.generateAuthUrl = function (clientId, clientSecret, options) {
        var _this = this;
        var scope = options.scope || default_js_1.DEFAULT_SCOPE;
        var redirect_uri = options.redirect_uri || default_js_1.NO_REDIRECT;
    ...
    Mastodon.prototype.fetchAccessToken = function (client_id_1, client_secret_1, code_1) {
        return __awaiter(this, arguments, void 0, function (client_id, client_secret, code, redirect_uri) {
            if (redirect_uri === void 0) { redirect_uri = default_js_1.NO_REDIRECT; }
            return __generator(this, function (_a) {
                if (!client_id) {
            ...
            return __generator(this, function (_a) {
                ...
                return [2, this.client.post('/api/v1/accounts', params).then(function (res) {
                        return Object.assign(res, {
                            data: api_client_js_1.default.Converter.token(res.data)
                        });
                    })];
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, this.client.get('/api/v1/accounts/verify_credentials').then(function (res) {
                        return Object.assign(res, {
                            data: api_client_js_1.default.Converter.account(res.data)
                        });
                    })];
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2, this.client.get("/api/v1/accounts/".concat(id, "/statuses"), params).then(function (res) {
                        return Object.assign(res, {
                            data: res.data.map(function (s) { return api_client_js_1.default.Converter.status(s); })
                        });
                    })];
            });
        });
    ...
    Mastodon.prototype.getAccountFavourites = function (_id, _options) {
        return new Promise(function (_, reject) {
            var err = new megalodon_js_1.NotImplementedError('Mastodon does not support this method');
            reject(err);
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2, this.client.post("/api/v1/accounts/".concat(id, "/follow"), params).then(function (res) {
                        return Object.assign(res, {
                            data: api_client_js_1.default.Converter.relationship(res.data)
                        });
                    })];
            });
        });
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        converted = Object.assign({}, res, {
                            data: res.data.map(function (a) { return api_client_js_1.default.Converter.account(a); })
                        });
                        if (!(get_all && converted.headers.link)) return [3, 6];
                        parsed = (0, parse_link_header_js_1.parseLinkHeader)(converted.headers.link);
                        _a.label = 2;
                    case 2:
                    ...
                    case 3:
                        ...
                        converted = Object.assign({}, converted, {
                            data: __spreadArray(__spreadArray([], __read(converted.data), false), __read(nextRes.data.map(function (a) { return api_client_js_1.default.Converter.account(a); })), false)
                        });
                        if (nextRes.headers.link === undefined) {
                            return [3, 6];
                        }
                        parsed = (0, parse_link_header_js_1.parseLinkHeader)(nextRes.headers.link);
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, this.client.get("/api/v1/accounts/".concat(id, "/lists")).then(function (res) {
                        return Object.assign(res, {
                            data: res.data.map(function (l) { return api_client_js_1.default.Converter.list(l); })
                        });
                    })];
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, this.client.get("/api/v1/accounts/".concat(id, "/identity_proofs")).then(function (res) {
                        return Object.assign(res, {
                            data: res.data.map(function (i) { return api_client_js_1.default.Converter.identity_proof(i); })
                        });
                    })];
            });
        });
    ...
    Mastodon.prototype.setAccountNote = function (id, note) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2, this.client.post("/api/v1/accounts/".concat(id, "/note"), params).then(function (res) {
                        return Object.assign(res, {
                            data: api_client_js_1.default.Converter.relationship(res.data)
                        });
                    })];
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, this.client
                        ...
                        .then(function (res) {
                        return Object.assign(res, {
                            data: api_client_js_1.default.Converter.relationship(res.data[0])
                        });
                    })];
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, this.client
                        ...
                        .then(function (res) {
                        return Object.assign(res, {
                            data: res.data.map(function (r) { return api_client_js_1.default.Converter.relationship(r); })
                        });
                    })];
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, this.client.get('/api/v1/filters').then(function (res) {
                        return Object.assign(res, {
                            data: res.data.map(function (f) { return api_client_js_1.default.Converter.filter(f); })
                        });
                    })];
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, this.client.get("/api/v1/filters/".concat(id)).then(function (res) {
                        return Object.assign(res, {
                            data: api_client_js_1.default.Converter.filter(res.data)
                        });
                    })];
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2, this.client.post('/api/v1/reports', params).then(function (res) {
                        return Object.assign(res, {
                            data: api_client_js_1.default.Converter.report(res.data)
                        });
                    })];
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, this.client.get('/api/v1/featured_tags').then(function (res) {
                        return Object.assign(res, {
                            data: res.data.map(function (f) { return api_client_js_1.default.Converter.featured_tag(f); })
                        });
                    })];
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, this.client
                        ...
                        .then(function (res) {
                        return Object.assign(res, {
                            data: api_client_js_1.default.Converter.featured_tag(res.data)
                        });
                    })];
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, this.client.get('/api/v1/featured_tags/suggestions').then(function (res) {
                        return Object.assign(res, {
                            data: res.data.map(function (t) { return api_client_js_1.default.Converter.tag(t); })
                        });
                    })];
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, this.client.get('/api/v1/preferences').then(function (res) {
                        return Object.assign(res, {
                            data: api_client_js_1.default.Converter.preferences(res.data)
                        });
                    })];
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, this.client.get('/api/v1/followed_tags').then(function (res) {
                        return Object.assign(res, {
                            data: res.data.map(function (tag) { return api_client_js_1.default.Converter.tag(tag); })
                        });
                    })];
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, this.client.get("/api/v1/tags/".concat(id)).then(function (res) {
                        return Object.assign(res, {
                            data: api_client_js_1.default.Converter.tag(res.data)
                        });
                    })];
            });
        });
            ...
            return __generator(this, function (_a) {
                ...
                if (scheduled) {
                    return [2, this.client.post('/api/v1/statuses', params).then(function (res) {
                            return Object.assign(res, {
                                data: api_client_js_1.default.Converter.scheduled_status(res.data)
                            });
                        })];
                }
                return [2, this.client.post('/api/v1/statuses', params).then(function (res) {
                        return Object.assign(res, {
                            data: api_client_js_1.default.Converter.status(res.data)
                        });
                    })];
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2, this.client.get("/api/v1/statuses/".concat(id, "/context"), params).then(function (res) {
                        return Object.assign(res, {
                            data: api_client_js_1.default.Converter.context(res.data)
                        });
                    })];
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, this.client.get("/api/v1/statuses/".concat(id, "/source")).then(function (res) {
                        return Object.assign(res, {
                            data: api_client_js_1.default.Converter.status_source(res.data)
                        });
                    })];
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2, this.client.postForm('/api/v2/media', formData).then(function (res) {
                        return Object.assign(res, {
                            data: api_client_js_1.default.Converter.async_attachment(res.data)
                        });
                    })];
            });
        });
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2, Object.assign(res, {
                                data: api_client_js_1.default.Converter.attachment(res.data)
                            })];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, this.client.get("/api/v1/polls/".concat(id)).then(function (res) {
                        return Object.assign(res, {
                            data: api_client_js_1.default.Converter.poll(res.data)
                        });
                    })];
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2, this.client.get('/api/v1/scheduled_statuses', params).then(function (res) {
                        return Object.assign(res, {
                            data: res.data.map(function (s) { return api_client_js_1.default.Converter.scheduled_status(s); })
                        });
                    })];
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2, this.client.get('/api/v1/conversations', params).then(function (res) {
                        return Object.assign(res, {
                            data: res.data.map(function (c) { return api_client_js_1.default.Converter.conversation(c); })
                        });
                    })];
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, this.client.post("/api/v1/conversations/".concat(id, "/read")).then(function (res) {
                        return Object.assign(res, {
                            data: api_client_js_1.default.Converter.conversation(res.data)
                        });
                    })];
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, this.client.get("/api/v1/lists/".concat(id)).then(function (res) {
                        return Object.assign(res, {
                            data: api_client_js_1.default.Converter.list(res.data)
                        });
                    })];
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, this.client
                        ...
                        .then(function (res) {
                        return Object.assign(res, {
                            data: api_client_js_1.default.Converter.marker(res.data)
                        });
                    })];
            });
        });
            ...
            return __generator(this, function (_a) {
                ...
                if (options) {
                    ...
                    if (options.exclude_types) {
                        params = Object.assign(params, {
                            exclude_types: options.exclude_types.map(function (e) { return api_client_js_1.default.Converter.encodeNotificationType(e); })
                        });
                    }
                ...
                return [2, this.client.get('/api/v1/notifications', params).then(function (res) {
                        return Object.assign(res, {
                            data: res.data.flatMap(function (n) {
                                var notify = api_client_js_1.default.Converter.notification(n);
                                if (notify instanceof notification_js_1.UnknownNotificationTypeError)
                                    return [];
                                return notify;
                            })
                        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        res = _a.sent();
                        notify = api_client_js_1.default.Converter.notification(res.data);
                        if (notify instanceof notification_js_1.UnknownNotificationTypeError) {
                            throw new notification_js_1.UnknownNotificationTypeError();
                        }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2, this.client.post('/api/v1/push/subscription', params).then(function (res) {
                        return Object.assign(res, {
                            data: api_client_js_1.default.Converter.push_subscription(res.data)
                        });
                    })];
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2, this.client.get('/api/v2/search', params).then(function (res) {
                        return Object.assign(res, {
                            data: api_client_js_1.default.Converter.results(res.data)
                        });
                    })];
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, this.client.get('/api/v1/instance').then(function (res) {
                        return Object.assign(res, {
                            data: api_client_js_1.default.Converter.instance(res.data)
                        });
                    })];
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, this.client.get('/api/v1/instance/activity').then(function (res) {
                        return Object.assign(res, {
                            data: res.data.map(function (a) { return api_client_js_1.default.Converter.activity(a); })
                        });
                    })];
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, this.client.get('/api/v1/custom_emojis').then(function (res) {
                        return Object.assign(res, {
                            data: res.data.map(function (e) { return api_client_js_1.default.Converter.emoji(e); })
                        });
                    })];
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, this.client.get('/api/v1/announcements').then(function (res) {
                        return Object.assign(res, {
                            data: res.data.map(function (a) { return api_client_js_1.default.Converter.announcement(a); })
                        });
                    })];
            });
        });

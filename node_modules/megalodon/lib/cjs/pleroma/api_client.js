    ...
    (function (Converter) {
        Converter.decodeNotificationType = function (t) {
            switch (t) {
                ...
                case notification_js_2.default.PleromaEmojiReaction:
                ...
                case notification_js_2.default.Move:
                    return notification_js_1.default.Move;
        ...
        Converter.encodeNotificationType = function (t) {
            switch (t) {
                ...
                case notification_js_1.default.Reaction:
                    return notification_js_2.default.PleromaEmojiReaction;
                ...
                case notification_js_1.default.Move:
                    return notification_js_2.default.Move;
        ...
        Converter.quote = function (s) {
            if (s.pleroma.quote) {
                return {
                    state: 'accepted',
                    quoted_status: Converter.status(s.pleroma.quote)
                };
            }

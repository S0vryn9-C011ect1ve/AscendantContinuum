...
var api_client_js_1 = __importDefault(require("./api_client.js"));
var notification_js_1 = require("../notification.js");
var default_js_1 = require("../default.js");
var WebSocket = (function (_super) {
    __extends(WebSocket, _super);
    function WebSocket(url, stream, params, accessToken, userAgent) {
    ...
    WebSocket.prototype._connect = function (url, stream, params, accessToken, headers) {
    ...
    WebSocket.prototype._clearBinding = function () {
        if (this._client && !(0, default_js_1.isBrowser)()) {
    ...
    WebSocket.prototype._setupParser = function () {
        ...
        this.parser.on('update', function (status) {
            _this.emit('update', api_client_js_1.default.Converter.status(status));
        });
        this.parser.on('notification', function (notification) {
            var n = api_client_js_1.default.Converter.notification(notification);
            if (n instanceof notification_js_1.UnknownNotificationTypeError) {
        ...
        this.parser.on('conversation', function (conversation) {
            _this.emit('conversation', api_client_js_1.default.Converter.conversation(conversation));
        });
        this.parser.on('status_update', function (status) {
            _this.emit('status_update', api_client_js_1.default.Converter.status(status));
        });

...
var api_client_js_1 = __importDefault(require("./pleroma/api_client.js"));
var megalodon_js_1 = require("./megalodon.js");
var default_js_1 = require("./default.js");
var PleromaOAuth = __importStar(require("./pleroma/oauth.js"));
var notification_js_1 = require("./notification.js");
var Pleroma = (function () {
    function Pleroma(baseUrl, accessToken, userAgent, axiosInstance) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, new Promise(function (_, reject) {
                        var err = new megalodon_js_1.NotImplementedError('Pleroma does not support this method');
                        reject(err);
                    })];
            });
        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4: return [2, new Promise(function (_, reject) {
                            var err = new megalodon_js_1.ArgumentError('id or max_id is required');
                            reject(err);
                        })];
                }
            });
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, this.client.get("/api/v1/pleroma/statuses/".concat(id, "/reactions")).then(function (res) {
                        return Object.assign(res, {
                            data: res.data.map(function (r) { return api_client_js_1.default.Converter.reaction(r); })
                        });
                    })];
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, this.client.get("/api/v1/pleroma/statuses/".concat(id, "/reactions/").concat(encodeURI(emoji))).then(function (res) {
                        return Object.assign(res, {
                            data: api_client_js_1.default.Converter.reaction(res.data)
                        });
                    })];
            });
        });

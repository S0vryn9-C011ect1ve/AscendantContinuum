...
var detector = function (url, axiosInstance) { return __awaiter(void 0, void 0, void 0, function () {
    var instance, res, link, _a, res_1, res_2, res_3;
    var _b, _c, _d;
    return __generator(this, function (_e) {
        switch (_e.label) {
            case 0:
                ...
                return [4, instance.get(url + '/.well-known/nodeinfo')];
            case 1:
                res = _e.sent();
                link = res.data.links.find(function (l) { return l.rel === NODEINFO_20 || l.rel === NODEINFO_21; });
                if (!link)
                    throw new megalodon_js_1.NodeinfoError('Could not find nodeinfo');
                _a = link.rel;
                switch (_a) {
                ...
                return [3, 8];
            case 2: return [4, instance.get(link.href)];
            case 3:
                res_1 = _e.sent();
                switch (res_1.data.software.name) {
                    ...
                    default:
                        ...
                        throw new megalodon_js_1.NodeinfoError('Unknown SNS');
                }
                _e.label = 4;
            case 4: return [4, instance.get(link.href)];
            case 5:
                res_2 = _e.sent();
                ...
                _e.label = 6;
            case 6: return [4, instance.get(link.href)];
            case 7:
                res_3 = _e.sent();
                ...
                _e.label = 8;
            case 8: throw new megalodon_js_1.NodeinfoError('Could not find nodeinfo');
        }
    });
}); };

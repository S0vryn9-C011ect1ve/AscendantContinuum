...
var api_client_js_1 = __importDefault(require("./gotosocial/api_client.js"));
var megalodon_js_1 = require("./megalodon.js");
var default_js_1 = require("./default.js");
var GotosocialOAuth = __importStar(require("./gotosocial/oauth.js"));
var notification_js_1 = require("./notification.js");
var Gotosocial = (function () {
    function Gotosocial(baseUrl, accessToken, userAgent, axiosInstance) {
    ...
    Gotosocial.prototype.verifyAppCredentials = function () {
        return new Promise(function (_, reject) {
            var err = new megalodon_js_1.NotImplementedError('Gotosocial does not support this method');
            reject(err);
        });
    };
    ...
    Gotosocial.prototype.editStatus = function (id, options) {
        return __awaiter(this, void 0, void 0, function () {

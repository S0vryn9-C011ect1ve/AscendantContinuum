...
var api_client_js_1 = __importDefault(require("./friendica/api_client.js"));
var megalodon_js_1 = require("./megalodon.js");
var default_js_1 = require("./default.js");
var FriendicaOAuth = __importStar(require("./friendica/oauth.js"));
var notification_js_1 = require("./notification.js");
var Friendica = (function () {
    function Friendica(baseUrl, accessToken, userAgent, axiosInstance) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, new Promise(function (_, reject) {
                        var err = new megalodon_js_1.NotImplementedError('Friendica does not support this method');
                        reject(err);
                    })];
            });
        });
            ...
            return __generator(this, function (_a) {
                if (limit) {
                    return [2, this.client
                            ...
                            .then(function (res) {
                            return Object.assign(res, {
                                data: res.data.map(function (a) { return api_client_js_1.default.Converter.follow_request(a); })
                            });
                        })];
                }
                else {

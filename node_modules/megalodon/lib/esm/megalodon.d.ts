...
declare const generator: (sns: 'mastodon' | 'pleroma' | 'friendica' | 'firefish' | 'gotosocial' | 'pixelfed', baseUrl: string, accessToken?: string | null, userAgent?: string | null, axiosInstance?: AxiosInstance) => MegalodonInterface;

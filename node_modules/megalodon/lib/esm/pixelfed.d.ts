...
export default class Pixelfed implements MegalodonInterface {
    client: PixelfedAPI.Interface;
    baseUrl: string;
    constructor(baseUrl: string, accessToken?: string | null, userAgent?: string | null, axiosInstance?: AxiosInstance);
    cancel(): void;
    ...
    setAccountNote(_id: string, _note?: string): Promise<Response<Entity.Relationship>>;
    ...
    getSuggestions(_limit?: number): Promise<Response<Array<Entity.Account>>>;
    ...
    pinStatus(_id: string): Promise<Response<Entity.Status>>;
    unpinStatus(_id: string): Promise<Response<Entity.Status>>;
    ...
    getListTimeline(_list_id: string, _options?: {
        limit?: number;
        max_id?: string;
        since_id?: string;
        min_id?: string;
    ...
    getList(_id: string): Promise<Response<Entity.List>>;
    createList(_title: string): Promise<Response<Entity.List>>;
    updateList(_id: string, _title: string): Promise<Response<Entity.List>>;
    deleteList(_id: string): Promise<Response<{}>>;
    getAccountsInList(_id: string, _options?: {
        limit?: number;
        max_id?: string;
        since_id?: string;
    }): Promise<Response<Array<Entity.Account>>>;
    addAccountsToList(_id: string, _account_ids: Array<string>): Promise<Response<{}>>;
    deleteAccountsFromList(_id: string, _account_ids: Array<string>): Promise<Response<{}>>;
    ...
    listStreaming(_list_id: string): Promise<WebSocketInterface>;

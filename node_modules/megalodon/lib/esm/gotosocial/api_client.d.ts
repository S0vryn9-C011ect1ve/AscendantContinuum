...
declare namespace GotosocialAPI {
    ...
    namespace Entity {
        ...
        type StatusVisibility = GotosocialEntity.StatusVisibility;
    ...
    namespace Converter {
        ...
        const visibility: (v: GotosocialAPI.Entity.StatusVisibility) => MegalodonEntity.StatusVisibility;
        const encodeVisibility: (v: MegalodonEntity.StatusVisibility) => GotosocialAPI.Entity.StatusVisibility;

# Legacy Unity First Steps Guide (Superseded)

This file is superseded by canonical implementation guidance.

Use:

1. `docs/operations/implementation-guides.md` for starter implementation flow
2. `docs/ASSET_PRODUCTION_GUIDE.md` for asset destination and naming rules
3. `docs/QUICK_REFERENCE_CHECKLIST.md` for checklist tracking

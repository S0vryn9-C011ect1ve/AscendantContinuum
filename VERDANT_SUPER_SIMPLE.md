# Verdant Sanctuary - Build Scene (Super Simple)

## What We're Doing
Building the Verdant Sanctuary realm where you click to water magical plants and watch them grow through 4 stages (Seed → Sprout → Plant → Bloom).

**Similar to:** Emberforge (but plants instead of sparks!)  
**Time needed:** 30-45 minutes  
**Difficulty:** Same as Emberforge ✅

---

## What You Already Have ✅

- ✅ **MagicalPlant.cs** script (the plant behavior)
- ✅ **VerdantGarden.cs** script (spawns and manages plants)
- ✅ **VerdantController.cs** script (connects to game systems)
- ✅ **MagicalPlant.prefab** (the plant GameObject)
- ✅ **Bloom.prefab** (bloomed plant variant - you created this yesterday!)
- ✅ **Plant_sprite.png** (in `_Project/Art/Generated/`)

---

## Part 1: Create the Scene (10 minutes)

### Step 1: Create New Scene

1. In Unity, top menu: **File → New Scene**
2. Choose: **2D (Built-in Render Pipeline)** or **Empty**
3. Click **Create**

### Step 2: Save the Scene

1. **Ctrl+S** (or File → Save As)
2. Navigate to: `Assets/_Project/Scenes/Realms/`
3. Name it: **`Realm_Verdant`**
4. Click **Save**

---

## Part 2: Set Up Camera (5 minutes)

### Step 1: Find the Camera

In **Hierarchy** panel (left):
- Look for **`Main Camera`** or **`Verdant_Camera`**
- **Click it** to select
...
**Camera Component:**
- **Projection:** `Orthographic` (click dropdown, select this)
- **Size:** `5` (or `6` if you want to see more area)
- **Background:** 
  - Click the **color box**
  - Choose a nature color (green `#2D5016`, or forest green `#1A3E1A`)
  - Or leave black for now
...
## Part 3: Create VerdantGarden GameObject (5 minutes)

### Step 1: Create Empty GameObject

1. In **Hierarchy**, **right-click** empty area
2. Select: **Create Empty**
3. Name it: **`[Verdant Garden]`**
   - Type this in Inspector at the top, or press F2 to rename
...
**Add VerdantController Script:**
1. With `[Verdant Garden]` selected
2. In **Inspector**, click **`Add Component`** button (bottom)
3. Type: **`Verdant Controller`**
4. Click it when it appears

**Add VerdantGarden Script:**
1. Click **`Add Component`** again
2. Type: **`Verdant Garden`**
3. Click it

**You should now see TWO script components in Inspector:**
- ✅ `Verdant Controller (Script)`
- ✅ `Verdant Garden (Script)`

---

## Part 4: Configure MagicalPlant Prefab (15 minutes)

### Step 1: Open MagicalPlant Prefab

1. **Project panel** (bottom)
2. Navigate: `Assets/_Project/Prefabs/Realms/Verdant/`
3. **Double-click** `MagicalPlant` prefab
   - Hierarchy changes to show just "MagicalPlant" (prefab mode)
   - Scene view may show blue background

### Step 2: Check Components

With `MagicalPlant` selected in Hierarchy, look at **Inspector**:

**You should see:**
- ✅ `Transform`
- ✅ `Sprite Renderer`
- ✅ `Magical Plant (Script)`
- ⚠️ Possibly `Circle Collider 2D` (if not, we'll add it)

### Step 3: Add Collider (If Missing)

**If you DON'T see Circle Collider 2D:**
1. Click **`Add Component`**
2. Type: **`Circle Collider 2D`**
3. Click it
4. In the new component:
   - **Radius:** `0.5`
   - **Is Trigger:** ✅ CHECK this box

**If you ALREADY have Circle Collider 2D:**
...
- If gray or see-through, click the color box and move alpha slider to max (far right)

### Step 5: Configure Magical Plant Script
